...
begin
  ...
  Begin
    ...
    fSearchIn := False;
  End
  Else If (RGDirection.ItemIndex = 2) Then
  Begin
    fSearchOut := False;
    fSearchIn := True;
  End
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      HasData := True;
    End
    else If (I >= $100) and (I <= $FFFF) Then
    Begin
      fUInt16Filter := I;
      fUInt16FilterOn := True;
      HasData := True;
    End
    Else If (I >= $10000) { and (I <= $FFFFFFFF) } Then
    Begin
      fUInt32Filter := I;
